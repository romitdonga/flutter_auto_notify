...
void main() {
  group('AutoNotifyConfig Tests', () {
    ...
    test('Custom values are set correctly', () {
      mockAnalytics(String event, Map<String, dynamic>? params) {}
    ...
    test('copyWith creates a new instance with updated values', () {
      ...
      final updated = original.copyWith(notifyInitialize: 1, hourStart: 10);
    ...
    test('assert validates hourEnd > hourStart', () {
      expect(
        () => AutoNotifyConfig(hourStart: 12, hourEnd: 10),
